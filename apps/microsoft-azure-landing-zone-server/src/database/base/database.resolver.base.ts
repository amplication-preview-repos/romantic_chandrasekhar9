...
export class DatabaseResolverBase {
  ...
  async createDatabase(
    ...
    return await this.service.createDatabase({
      ...
      data: {
        ...
        storageAccount: args.data.storageAccount
          ? {
              connect: args.data.storageAccount,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => StorageAccount, {
    nullable: true,
    name: "storageAccount",
  })
  async getStorageAccount(
    ...
    const result = await this.service.getStorageAccount(parent.id);
